...
<span class="mkdf-taxonomy-image"><img src="
          <?php  echo base_url();  ?>assets/images/type-3-img.png" alt="Taxonomy Custom Icon">
    </span> 
  </div>
<div class="mkdf-ptl-item-title">Apartment
</div>      
<a itemprop="url" class="mkdf-ptl-item-link" href="#" target="_self">
</a>
</div>
</li>
  ...
  <div class="mkdf-ptl-item-inner">
    <div class="mkdf-ptl-item-image">
      <span class="mkdf-taxonomy-image">
        <img src="<?php  echo base_url();  ?>assets/images/type-4-img.png" alt="Taxonomy Custom Icon">
      </span> 
    </div>
    <div class="mkdf-ptl-item-title">Building
    </div>   
    <a itemprop="url" class="mkdf-ptl-item-link" href="#" target="_self">
    </a>
  </div>
...
<li class="mkdf-ptl-item mkdf-item-space " data-id="21">
  <div class="mkdf-ptl-item-inner">
    ...
    <div class="mkdf-ptl-item-title">Condominium
    </div>      
    <a itemprop="url" class="mkdf-ptl-item-link" href="#" target="_self">
    </a>
  </div>
...
<li class="mkdf-ptl-item mkdf-item-space " data-id="22">
  <div class="mkdf-ptl-item-inner">
    <div class="mkdf-ptl-item-image">
      <span class="mkdf-taxonomy-image">
        <img src="<?php  echo base_url();  ?>assets/images/type-6-img.png" alt="Taxonomy Custom Icon">
      </span>   
    </div>
    <div class="mkdf-ptl-item-title">House
    </div>     
    <a itemprop="url" class="mkdf-ptl-item-link" href="#" target="_self">
    </a>
  </div>
...
<li class="mkdf-ptl-item mkdf-item-space " data-id="17">
  <div class="mkdf-ptl-item-inner">
    <div class="mkdf-ptl-item-image">
      <span class="mkdf-taxonomy-image">
        <img src="<?php  echo base_url();  ?>assets/images/type-1-img.png" alt="Taxonomy Custom Icon">
      </span>   
    </div>
    <div class="mkdf-ptl-item-title">Office
    </div>  
    <a itemprop="url" class="mkdf-ptl-item-link" href="#" target="_self">
    </a>
  </div>
...
<li class="mkdf-ptl-item mkdf-item-space " data-id="18">
  <div class="mkdf-ptl-item-inner">
    <div class="mkdf-ptl-item-image">
      <span class="mkdf-taxonomy-image">
        <img src="<?php  echo base_url();  ?>assets/images/type-2-img.png" alt="Taxonomy Custom Icon">
      </span>  
    </div>
    <div class="mkdf-ptl-item-title">Shop
    </div>     
    <a itemprop="url" class="mkdf-ptl-item-link" href="#" target="_self">
    </a>
  </div>
      ...
      <div class="mkdf-filter-features-wrapper clearfix">
        ...
        <div class="mkdf-feature-item">
          ...
          <label class="mkdf-checkbox-label" for="mkdf-feature-45">
            ...
            <span class="mkdf-label-text">Granite Countertops 
            </span>
          </label>
        </div>
        <div class="mkdf-feature-item">
        ...
        <div class="mkdf-feature-item">
          ...
          <label class="mkdf-checkbox-label" for="mkdf-feature-43">
            ...
            <span class="mkdf-label-text">Wi Fi in Common Areas
            </span>
          </label>
        </div>
      </div>
      ...
      <div class="mkdf-item-bottom-section">
        <div class="mkdf-item-bottom-section-content">
          <h5 itemprop="name" class="mkdf-pli-title entry-title">
            <a itemprop="url" href="#" target="_self">4878 Orange Ave
            </a>
          </h5>        
