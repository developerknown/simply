...
<head>
    ...
    <!--easy pie chart-->
    <link href="<?php echo base_url();?>css/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen" />
    <!--vector maps -->
    <link rel="stylesheet" href="<?php echo base_url();?>css/jquery-jvectormap-1.1.1.css">
    <!--right slidebar-->
    <link href="<?php echo base_url();?>css/slidebars.css" rel="stylesheet">
    <!--switchery-->
    <link href="<?php echo base_url();?>css/switchery.min.css" rel="stylesheet" type="text/css" media="screen" />
    <!--jquery-ui-->
    <link href="<?php echo base_url();?>css/jquery-ui-1.10.1.custom.min.css" rel="stylesheet" />
    <!--iCheck-->
	...
	<link href="<?php echo base_url();?>css/jquery-ui-1.10.3.css" rel="stylesheet">
	<link href="<?php echo base_url();?>css/font-awesome.css" rel="stylesheet">
	<link href="<?php echo base_url();?>css/simple-line-icons.css" rel="stylesheet">
	<link href="<?php echo base_url();?>css/icomoon-weather.css" rel="stylesheet">
                            ...
                            <div class="post-info">
                                <ul class="team-list cycle-pager external" id='no-template-pager'>
                                    ...
                                    <li>
                                        <a href="javascript:;">
                                            <span class="thumb-small">
                                                <img class="circle" src="images/img4.jpg" alt=""/>
...
<script src="<?php echo base_url();?>js/switchery-init.js"></script>

<!--flot chart -->
<script src="<?php echo base_url();?>js/jquery.flot.js"></script>
<script src="<?php echo base_url();?>js/flot-spline.js"></script>
...
<script src="<?php echo base_url();?>js/jquery.flot.selection.js"></script>
<script src="<?php echo base_url();?>js/jquery.flot.stack.js"></script>
<script src="<?php echo base_url();?>js/jquery.flot.crosshair.js"></script>
...
<script src="<?php echo base_url();?>js/sparkline-init.js"></script>
...
<!--jquery countTo-->
<script src="<?php echo base_url();?>js/jquery.countTo.js"  type="text/javascript"></script>
