...
<head>
    ...
    <title>Change Password| Simply</title>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <div class="panel-body">
                            <?php
                                if($this->session->flashdata('pass_update_sccs')){
                            ?>
                                <div class="alert alert-success"> <strong><?php echo $this->session->flashdata('pass_update_sccs');?></strong> </div>
                            <?php
                            ...
                            ?>
                            <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url('settings/chng_password');?>" enctype="multipart/form-data">
                                <div class="col-lg-6">
                                 
									  <div class="form-group">
                                        <label for="inputpropname" class="col-lg-3 col-sm-3 control-label">New Password</label>
                                        <div class="col-lg-8">
                                            <input type="password" class="form-control" id="inputpropname" placeholder="Enter Your New Password" name="new_password">
