...
<head>
    ...
    <title>Add Location | Simply</title>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <div class="panel-body">
                            <?php
                                if($this->session->flashdata('add_location_successfull')){
                            ?>
                                <div class="alert alert-success"> <strong><?php echo $this->session->flashdata('add_location_successfull');?></strong> </div>
                            <?php
                                }else if($this->session->flashdata('add_location_failed')){
                            ?>
                                <div class="alert alert-danger"> <strong><?php echo $this->session->flashdata('add_location_failed');?></strong> </div>
                            <?php
                                }
                            ?>
                            <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url('add_location/add_new_location');?>" enctype="multipart/form-data">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="inputpropname" class="col-lg-3 col-sm-3 control-label">Country Name</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" id="inputpropname" placeholder="Season Name" name="season_name" value="France" Disabled>
                                            <!--<p class="help-block">Example block-level help text here.</p>-->
                                        </div>
                                    </div>

									  <div class="form-group">
                                        <label for="inputpropname" class="col-lg-3 col-sm-3 control-label">City Name</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" id="inputpropname" placeholder="Enter City Name" name="city_name">
                                            <!--<p class="help-block">Example block-level help text here.</p>-->
                                        </div>
                                    </div>
