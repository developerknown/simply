...
<head>
    ...
    <title>Holiday Rental Booking | Simply</title>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                             ...
                                             $get_user_info = $this->holiday_rental_booking_m->user_info($user_id);
                                             echo ucfirst($get_user_info->name);
                                            ?> 
                                        </td>
                                        <td>
                                            <?php
                                             $holiday_rental_id = $fetch_each_property->holiday_rental_id;
                                             $get_rental_info = $this->holiday_rental_booking_m->rental_property_info($holiday_rental_id);
                                             echo $get_rental_info->name;
                                            ?>
                                        </td>
